Aplicação para implementar estudos, voltados a back-end, construção de api's e cases para integração a um front-end para unicamente a finalidade de implementar funcionalidades com fim de estudos.
